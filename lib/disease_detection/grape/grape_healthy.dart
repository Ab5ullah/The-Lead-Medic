...
class GrapeHealthyPage extends StatefulWidget {
  @override
  _GrapeHealthyPageState createState() => _GrapeHealthyPageState();
}

class _GrapeHealthyPageState extends State<GrapeHealthyPage> {
            ...
            child: Column(
              ...
              children: [
                ...
                CarouselSlider(
                  ...
                  items: [
                    'assets/images/grape/Grape___healthy1.jpg',
                    'assets/images/grape/Grape___healthy2.jpg',
                    'assets/images/grape/Grape___healthy3.jpg',
                  ].map((item) {
                    return Builder(
                ...
                Padding(
                  ...
                  child: Text(
                    'Maintaining the health of grapevines is crucial for optimal growth and fruit production. Healthy grapevines are resilient against diseases and pests, ensuring a bountiful harvest. Implementing proper care practices and using appropriate fertilizers can significantly contribute to their well-being.',
                    style: TextStyle(fontSize: 17, color: Colors.black87),
                      ...
                      child: ListBody(
                        children: [
                          _buildBulletDot(
                              'Vigorous growth with lush green foliage.'),
                          _buildBulletDot(
                              'Strong, well-formed vines and canopy.'),
                    ...
                    children: [
                      RichText(
                        text: TextSpan(
                          ...
                          children: <TextSpan>[
                            TextSpan(
                              text: 'Vitis vinifera (Common Grape Vine).',
                              style: TextStyle(
                                fontSize: 17,
                      ...
                      SizedBox(height: 5),
                      Text(
                        '• Grape Varieties: There are numerous cultivated varieties of grapes, each with unique characteristics and flavors. Some popular varieties include Cabernet Sauvignon, Chardonnay, Merlot, and Riesling.',
                        style: TextStyle(
                          fontSize: 17,
                          color: Colors.black87,
                        ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 12),
                        Text(
                          'To maintain the health of grapevines, provide adequate sunlight and well-drained soil. Prune regularly to improve air circulation and remove dead or diseased vines. Apply fertilizers tailored to grapevines\' needs during the growing season, focusing on nitrogen, phosphorus, and potassium. Mulch around the base of the vines to retain moisture and suppress weed growth. Monitor for pests and diseases and take prompt action if detected.',
                          style: TextStyle(fontSize: 17, color: Colors.black87),
                        ),
                        SizedBox(height: 10),
                        Divider(
                        ...
                        SizedBox(height: 12),
                        Text(
                          'To maintain healthy grapevines and manage pests effectively, consider the following strategies:',
                          style: TextStyle(
                            fontSize: 17,
                            // fontWeight: FontWeight.bold,
                            color: Colors.black87,
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5),
                            Text(
                              'Use sulfur dust to control powdery mildew, a common fungal disease affecting grapevines. Apply according to label directions during the growing season.',
                              style: TextStyle(
                                fontSize: 17,
                                color: Colors.black87,
                              ),
                            ...
                            SizedBox(height: 5),
                            Text(
                              'Neem oil can be effective against aphids, mites, and other common grape pests. Dilute according to instructions and apply as needed.',
                              style: TextStyle(
                                fontSize: 17,
                                color: Colors.black87,
                              ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 12),
                        Text(
                          'To maintain healthy grapevines, consider these preventive measures:',
                          style: TextStyle(fontSize: 17, color: Colors.black87),
                        ),
                        SizedBox(height: 12),
                        ...
                        ListBody(
                          children: [
                            _buildBulletDot(
                                'Choose disease-resistant grape varieties suitable for your local climate.'),
                            _buildBulletDot(
                                'Conduct regular inspections for early detection of any signs of pests or diseases.'),
                            _buildBulletDot(
                                'Monitor and control soil moisture levels to prevent stress.'),
                            ...
                            _buildBulletDot(
                                'Keep the area around vines free from weeds and debris.'),
                          ],
                        ),
                        SizedBox(height: 10),
                        Divider(
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 5),
                            Text(
                              ' Fertilizers for Healthy Grapevines:',
                              style: TextStyle(
                                fontSize: 20,
                                fontWeight: FontWeight.bold,
                              ),
                        ...
                        SizedBox(height: 12),
                        Text(
                          'Recommended fertilizers to promote healthy grapevine growth:',
                          style: TextStyle(
                            fontSize: 17,
                            color: Colors.black87,
                          ),
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5),
                            Text(
                              'Use Calcium Nitrate fertilizer to provide calcium and nitrogen, essential for healthy grape growth. Follow recommended guidelines for application.',
                              style: TextStyle(
                                fontSize: 17,
                                color: Colors.black87,
                              ),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 12),
                      Text(
                        'Healthy grapevines thrive due to optimal growing conditions and proper care practices. They are less susceptible to diseases and pests, ensuring robust growth and high-quality fruit production.',
                        style: TextStyle(fontSize: 17, color: Colors.black87),
                      ),
                      SizedBox(height: 10),
                      Divider(
