...
import 'package:the_leaf_medic/cultivation/cotton/cotton_culture.dart';
import 'package:the_leaf_medic/cultivation/cotton/cotton_detail.dart';
...
class _CornDetailPageState extends State<CottonDetailPage> {
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: Image.asset(
              'assets/images/cotton/cottonfield.jpeg',
              fit: BoxFit.cover,
            ),
          ),
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => CottonDetailsPage(),
                    ),
                  );
                },
                child: Container(
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => CottonCulturePage(),
                            ),
                          );
                        },
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Image.asset(
                        'assets/images/cotton/cotton_culti.png',
                        width: 28,
                        height: 25,
                      ),
                      SizedBox(width: 5),
                    ...
                    child: AnimatedCrossFade(
                      ...
                      firstChild: Row(
                        children: [
                          Expanded(
                            child: Text(
                              'Cotton is a crucial cash crop in Pakistan,.... ',
                              style: TextStyle(
                                fontSize: 13,
                                color: Colors.white,
                              ),
                      ...
                      secondChild: Text(
                        'Cotton is a crucial cash crop in Pakistan, flourishing in warm climates and well-drained soils. It is a primary source of raw material for the thriving textile industry, playing a vital role in the country\'s economy and providing employment opportunities.',
                        style: TextStyle(
                          fontSize: 13,
                          color: Colors.white,
                        ),
