...
import 'package:the_leaf_medic/cultivation/apple/apple_culture.dart';
import 'package:the_leaf_medic/cultivation/apple/apple_detail.dart';
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: Image.asset(
              'assets/images/apple/applefield.jpeg',
              fit: BoxFit.cover,
            ),
          ),
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => AppleDetailsPage(),
                    ),
                  );
                },
                child: Container(
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => AppleCulturePage(),
                            ),
                          );
                        },
                ...
                children: [
                  Row(
                    children: [
                      ...
                      SizedBox(width: 7),
                      Image.asset(
                        'assets/images/apple/apple_culti.png',
                        width: 28,
                        height: 25,
                      ),
                      SizedBox(width: 5),
                    ...
                    child: AnimatedCrossFade(
                      ...
                      firstChild: Row(
                        children: [
                          Expanded(
                            child: Text(
                              'Apples are a popular fruit crop in many parts of...',
                              style: TextStyle(
                                fontSize: 13,
                                color: Colors.white,
                              ),
                      ...
                      secondChild: Text(
                        'Apples are a popular fruit crop in many parts of the world, thriving in temperate climates and well-drained soils. Known for their sweet taste and nutritional value, apples play a crucial role in both local agriculture and the global market, contributing significantly to the economy and diet of many regions.',
                        style: TextStyle(
                          fontSize: 13,
                          color: Colors.white,
                        ),
